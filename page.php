...
<div class="page-banner overlay-dark bg-image" style="background-image: url('<?php echo $imagepath[0] ?>');"
  ...
  <!-- <div class="page-section bg-light">
    /* <?php echo get_template_directory_uri()?>/assets/img/bg_image_1.jpg) */
    <div class="container">
      <div class="row">
