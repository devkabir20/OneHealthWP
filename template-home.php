...
<?php $imagepath= wp_get_attachment_image_src(get_post_thumbnail_id());?>
 <div
      ...
      style="background-image: url('<?php echo $imagepath[0] ?>')"
    >
          ...
          <div class="row align-items-center">
            ...
            <div class="col-lg-6 wow fadeInRight" data-wow-delay="400ms">
              <div class="img-place custom-img-1">
                <img src="<?php echo get_template_directory_uri()?>/assets/img/bg-doctor.png" alt="" />
              </div>
            </div>
          </div>
        </div>
        ...
        <div class="owl-carousel wow fadeInUp" id="doctorSlideshow">
          <div class="item">
            <div class="card-doctor">
              <div class="header">
                <img src="<?php echo get_template_directory_uri()?>/assets/img/doctors/doctor_1.jpg" alt="" />
                <div class="meta">
          ...
          <div class="item">
            <div class="card-doctor">
              <div class="header">
                <img src="<?php echo get_template_directory_uri()?>/assets/img/doctors/doctor_2.jpg" alt="" />
                <div class="meta">
                  <a href="#"><span class="mai-call"></span></a>
                  <a href="#"><span class="mai-logo-whatsapp"></span></a>
                </div>
          ...
          <div class="item">
            <div class="card-doctor">
              <div class="header">
                <img src="<?php echo get_template_directory_uri()?>/assets/img/doctors/doctor_3.jpg" alt="" />
                <div class="meta">
                  <a href="#"><span class="mai-call"></span></a>
                  <a href="#"><span class="mai-logo-whatsapp"></span></a>
                </div>
            ...
            <div class="card-blog">
              ...
              <div class="body">
                ...
                <div class="site-info">
                  <div class="avatar mr-2">
                    <div class="avatar-img">
                      <img src="<?php echo get_template_directory_uri()?>/assets/img/person/person_2.jpg" alt="" />
                    </div>
    ...
    <div
      ...
      style="background-image: url(<?php echo get_template_directory_uri()?>/assets/img/banner-pattern.svg)"
    >
      <div class="container py-5 py-lg-0">
        <div class="row align-items-center">
          ...
          <div class="col-lg-8 wow fadeInRight">
            ...
            <a href="#" class="ml-2"
              ><img src="<?php echo get_template_directory_uri()?>/assets/img/app_store.svg" alt=""
            /></a>
          </div>
        </div>
      </div>
